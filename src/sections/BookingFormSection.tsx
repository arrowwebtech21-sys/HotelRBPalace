...
import { Calendar, Send, Utensils, User, Mail, Phone, BedDouble, MessageSquare, Sparkles, ShieldCheck, Clock, Award, Star } from 'lucide-react';
  ...
  return (
    <section id="booking-form" className="py-24 px-6 sm:px-12 max-w-[1400px] mx-auto relative">
      ...
      <div className="bg-[#172215] text-white rounded-[36px] sm:rounded-[44px] p-8 sm:p-12 md:p-14 shadow-3xl relative overflow-hidden border border-[#85AB8B]/25">
        ...
        {/* Background Ambient Glow Orbs & Lattice Watermark Props */}
        ...
        <form onSubmit={onSubmit} className="relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div className="sm:col-span-2 md:col-span-3 mt-4 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <Magnet padding={60} strength={2}>
              <button
                type="submit"
                className="bg-[#85AB8B] hover:bg-[#6e9674] text-[#172215] font-bold text-sm px-9 py-4 rounded-full flex items-center gap-2.5 shadow-2xl hover:shadow-3xl hover:scale-105 active:scale-95 transition-all cursor-pointer"
              >
